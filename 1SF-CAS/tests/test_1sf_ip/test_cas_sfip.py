...
def test_1():
    ...
    e = fock_ci( 2, 1, n2_7, conf_space="", ref_opts=options )
...
def test_2():
    ...
    e = fock_ci( 2, 1, n2_3, conf_space="", ref_opts=options )
    assert abs(e[0] - expected) < threshold
...
def test_3():
    ...
    e = fock_ci( 2, 1, o2, conf_space="", ref_opts=options, sf_opts={'NUM_ROOTS': 2} )
    assert abs(e[0] - expected) < threshold
