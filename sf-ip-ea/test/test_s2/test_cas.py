...
def test_cas_1sf():
    ...
    e, vects = fock_ci( 1, 1, n2_7, conf_space="", ref_opts=options, sf_opts={'return_vects': True} )
...
def test_h_1sf():
    ...
    s_expected = [6.0, 12.0, 6.0, 6.0, 6.0, 6.0]
    e, vects = fock_ci( 1, 1, n2_7, conf_space="h", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_p_1sf():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [6.0, 12.0, 6.0, 6.0, 6.0, 6.0]
    e, vects = fock_ci( 1, 1, n2_7, conf_space="p", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_hp_1sf():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [6.0, 12.0, 6.0, 6.0, 6.0, 6.0]
    e, vects = fock_ci( 1, 1, n2_7, conf_space="h,p", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_cas_ea():
    ...
    e, vects = fock_ci( 0, 1, n2_7, conf_space="", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_cas_ip():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 8.75, 8.75, 8.75, 8.75]
    e, vects = fock_ci( 1, 0, n2_7, conf_space="", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
        s2 = post_ci_analysis.calc_s_squared(0, -1, "", vects[:, i], 4, 6, 18) 
        assert abs(s2 - s_expected[i]) < threshold
...
def test_cas_1sfea():
    ...
    e, vects = fock_ci( 1, 2, n2_7, conf_space="", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_cas_1sfip():
    ...
    e, vects = fock_ci( 2, 1, n2_7, conf_space="", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
        s2 = post_ci_analysis.calc_s_squared(1, -1, "", vects[:, i], 4, 6, 18) 
        assert abs(s2 - s_expected[i]) < threshold
...
def test_h_1sfip():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 3.75, 3.75, 3.75, 8.75, 8.75]
    e, vects = fock_ci( 2, 1, n2_7, conf_space="h", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_p_1sfea():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 3.75, 3.75, 3.75, 8.75, 8.75]
    e, vects = fock_ci( 1, 2, n2_7, conf_space="p", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_h_ea():
    ...
    e, vects = fock_ci( 0, 1, n2_7, conf_space="h", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_h_ip():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 8.75, 8.75, 8.75, 8.75]
    e, vects = fock_ci( 1, 0, n2_7, conf_space="h", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
        s2 = post_ci_analysis.calc_s_squared(0, -1, "h", vects[:, i], 4, 6, 18) 
        assert abs(s2 - s_expected[i]) < threshold
...
def test_p_ea():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 8.75, 8.75, 8.75, 8.75]
    e, vects = fock_ci( 0, 1, n2_7, conf_space="p", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
...
def test_p_ip():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 8.75, 8.75, 8.75, 8.75]
    e, vects = fock_ci( 1, 0, n2_7, conf_space="p", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
        s2 = post_ci_analysis.calc_s_squared(0, -1, "p", vects[:, i], 4, 6, 18) 
        assert abs(s2 - s_expected[i]) < threshold
...
def test_cas_2sf():
    ...
    e, vects = fock_ci( 2, 2, n2_7, conf_space="", ref_opts=options, sf_opts={'return_vects': True} )
    for i in range(len(s_expected)):
