...
def test_1():
    ...
    e = sf_psi4( 1, 2, n2_7, conf_space="h", add_opts=options )
...
def test_2():
    ...
    e = sf_psi4( 1, 2, n2_3, conf_space="h", add_opts=options )
    assert abs(e[0] - expected) < threshold
...
def test_3():
    ...
    e = sf_psi4( 1, 2, o2, conf_space="h", add_opts=options, num_roots=2 )
    assert abs(e[0] - expected) < threshold
