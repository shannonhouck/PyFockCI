...
def test_1():
    ...
    e = sf_psi4( 1, 1, n2_7, conf_space="h,p", add_opts=options, num_roots=4, guess_type="RANDOM" )
...
def test_2():
    ...
    e = sf_psi4( 1, 1, n2_3, conf_space="h,p", add_opts=options, num_roots=4, guess_type="RANDOM" )
    assert abs(e[0] - expected) < threshold
