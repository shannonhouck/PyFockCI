...
def test_hp_1sf():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [6.0, 12.0, 6.0, 6.0, 6.0, 6.0]
    e, vects = sf_psi4( 1, 1, n2_7, conf_space="h,p", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
...
def test_cas_ea():
    ...
    e, vects = sf_psi4( 0, 1, n2_7, conf_space="", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
...
def test_cas_ip():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 8.75, 8.75, 8.75, 8.75]
    e, vects = sf_psi4( 1, 0, n2_7, conf_space="", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
        s2 = post_ci_analysis.calc_s_squared(0, -1, "", vects[:, i], 4, 6, 18) 
        assert abs(s2 - s_expected[i]) < threshold
...
def test_cas_1sfea():
    ...
    e, vects = sf_psi4( 1, 2, n2_7, conf_space="", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
...
def test_cas_1sfip():
    ...
    e, vects = sf_psi4( 2, 1, n2_7, conf_space="", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
        s2 = post_ci_analysis.calc_s_squared(1, -1, "", vects[:, i], 4, 6, 18) 
        assert abs(s2 - s_expected[i]) < threshold
...
def test_h_1sfip():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 3.75, 3.75, 3.75, 8.75, 8.75]
    e, vects = sf_psi4( 2, 1, n2_7, conf_space="h", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
...
def test_p_1sfea():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [8.75, 3.75, 3.75, 3.75, 3.75, 3.75]
    e, vects = sf_psi4( 1, 2, n2_7, conf_space="p", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
