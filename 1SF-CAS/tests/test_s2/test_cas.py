...
def test_cas_1sf():
    ...
    e, vects = sf_psi4( 1, 1, n2_7, conf_space="", add_opts=options, return_vects=True )
...
def test_h_1sf():
    ...
    s_expected = [6.0, 12.0, 6.0, 6.0, 6.0, 6.0]
    e, vects = sf_psi4( 1, 1, n2_7, conf_space="h", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
...
def test_p_1sf():
    ...
    options = {"basis": "cc-pvdz", 'num_roots': 4, 'diis_start': 20, 'e_convergence': 1e-10, 'd_convergence': 1e-10}
    s_expected = [6.0, 12.0, 6.0, 6.0, 6.0, 6.0]
    e, vects = sf_psi4( 1, 1, n2_7, conf_space="p", add_opts=options, return_vects=True )
    for i in range(len(s_expected)):
